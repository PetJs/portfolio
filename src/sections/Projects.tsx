    ...
    return (
        <section className="sm:px-10 px-5 my-20">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                <div className="flex flex-col gap-5 realtive sm:p-10 py-10 px-5 shadow-2xl shadow-[#0E0E10]">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-5">
                        ...
                        <a href={currentProject.href} target="_blank" rel="noreferrer" className="flex items-center gap-2 cursor-pointer text-[#AFB0B6]">
                            <p>Check live site</p>
                ...
                <div className="bordeer border-[#1C1C21] bg-[#0E0E10] rounded-lg h-96 md:h-full">
                    <Canvas>
